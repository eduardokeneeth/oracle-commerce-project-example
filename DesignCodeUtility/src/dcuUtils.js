...
/**
 * Holds the boilerplate for prompting the user
 * @param questions
 */
exports.pose = function(questions) {
...
function getI18nConfirmPrompt() {
  ...
  const i18nConfirm = function (question, rl, answers) {
    ...
    this.confirm.opt.filter = function (input) {
      ...
      // Since this is nls text, compare on the yes and take everything else as no.
      return input === t("shortYesText")
    }
